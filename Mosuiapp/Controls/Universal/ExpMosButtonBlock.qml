...
Flickable {
    ...
    Column {
        ...
        MosDescription {
            desc: qsTr(`
# ExpButtonBlock 按钮块(MosIconButton变种) \n
...
model | array | [] | 按钮块模型
count | int | - | 按钮数量
size | enum | ExpButtonBlock.Size_Auto | 按钮项大小(来自 ExpButtonBlock)
buttonWidth | int | 120 | 按钮项宽度(size == ExpButtonBlock.Size_Fixed 生效)
buttonHeight | int | 30 | 按钮项高度(size == ExpButtonBlock.Size_Fixed 生效)
