...
mode | enum | MosTimeline.Mode_Left | 时间节点展现模式(来自 MosTimeline)
            ...
            code: `
                ...
                Column {
                    ...
                    MosTimeline {
                        ...
                        initModel: [
                            {
                                colorNode: MosTheme.Primary.colorSuccess,
                                content: 'Create a services site',
                            },
                            {
                                colorNode: MosTheme.Primary.colorError,
                                content: 'Solve initial network problems 1\nSolve initial network problems 2\nSolve initial network problems 3',
                            },
                            {
                                colorNode: MosTheme.Primary.colorWarning,
...
- 时间在轴左侧(默认){ MosTimeline.Mode_Left }\n
- 时间在轴右侧{ MosTimeline.Mode_Right }\n
- 交替展现{ MosTimeline.Mode_Alternate }\n
            ...
            code: `
                ...
                Column {
                    ...
                    MosRadioBlock {
                        ...
                        initCheckedIndex: 0
                        model: [
                            { label: 'Left', value: MosTimeline.Mode_Left },
                            { label: 'Right', value: MosTimeline.Mode_Right },
                            { label: 'Alternate', value: MosTimeline.Mode_Alternate }
                        ]
                    }
