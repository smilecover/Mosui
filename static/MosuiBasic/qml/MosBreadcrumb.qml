...
T.Control {
    ...
    QtObject {
        ...
        function initObject(object: var): var {
            ...
            if (!object.hasOwnProperty('iconUrl') || object.iconUrl == null) object.iconUrl = '';
            if (!object.hasOwnProperty('iconSize') || object.iconSize == null) object.iconSize = root.defaultIconSize;
            if (!object.hasOwnProperty('loading') || object.loading == null) object.loading = false;
