...
MosSizeGenerator::MosSizeGenerator(QObject *parent)
    : QObject{parent}
{

}

MosSizeGenerator::~MosSizeGenerator()
{

}

QList<qreal> MosSizeGenerator::generateFontSize(qreal fontSizeBase)
{
...
QList<qreal> MosSizeGenerator::generateFontLineHeight(qreal fontSizeBase)
{
