...
[[maybe_unused]] static auto qHash(MosColorGenerator::Preset preset)
{
    return static_cast<std::underlying_type<MosColorGenerator::Preset>::type>(preset);
}
...
static qreal getSaturation(const QColor &hsv, int i, bool light = false)
{
    ...
    if (hsv.hsvHue() == 0 && hsv.hsvSaturationF() == 0) {
...
MosColorGenerator::MosColorGenerator(QObject *parent)
    : QObject{parent}
{

}

MosColorGenerator::~MosColorGenerator()
{

}

QColor MosColorGenerator::reverseColor(const QColor &color)
{
    return QColor(255 - color.red(), 255 - color.green(), 255 - color.blue(), color.alpha());
}

QColor MosColorGenerator::presetToColor(const QString &color)
{
...
QColor MosColorGenerator::presetToColor(MosColorGenerator::Preset color)
{
    using PresetTableType = QHash<MosColorGenerator::Preset, QColor>;
    static PresetTableType g_presetTable {
        { MosColorGenerator::Preset::Preset_Red,      QColor(0xF5222D) },
        { MosColorGenerator::Preset::Preset_Volcano,  QColor(0xFA541C) },
        { MosColorGenerator::Preset::Preset_Orange,   QColor(0xFA8C16) },
        { MosColorGenerator::Preset::Preset_Gold,     QColor(0xFAAD14) },
        { MosColorGenerator::Preset::Preset_Yellow,   QColor(0xFADB14) },
        { MosColorGenerator::Preset::Preset_Lime,     QColor(0xA0D911) },
        { MosColorGenerator::Preset::Preset_Green,    QColor(0x52C41A) },
        { MosColorGenerator::Preset::Preset_Cyan,     QColor(0x13C2C2) },
        { MosColorGenerator::Preset::Preset_Blue,     QColor(0x1677FF) },
        { MosColorGenerator::Preset::Preset_Geekblue, QColor(0x2F54EB) },
        { MosColorGenerator::Preset::Preset_Purple,   QColor(0x722ED1) },
        { MosColorGenerator::Preset::Preset_Magenta,  QColor(0xEB2F96) },
        { MosColorGenerator::Preset::Preset_Grey,     QColor(0x666666) }
    };
...
QList<QColor> MosColorGenerator::generate(MosColorGenerator::Preset color, bool light, const QColor &background)
{
    return generate(presetToColor(color), light, background);
}

QList<QColor> MosColorGenerator::generate(const QColor &color, bool light, const QColor &background)
{
